...
class ResultTest {
    ...
    void swap() {
        ...
        assertThat(res.<Integer>fold(r -> -1, identity())).isEqualTo(-1);
        assertThat(res.swap().<Integer>fold(r -> -1, identity())).isEqualTo(value);
        assertThat(res.swap().swap().<Integer>fold(r -> -1, identity())).isEqualTo(-1);
    }
}
